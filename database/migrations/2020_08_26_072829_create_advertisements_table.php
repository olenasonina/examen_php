...
class CreateAdvertisementsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('advertisements', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('incoterms_id')->comment('FK');
            ...
            $table->string('web-syte',255);
            $table->string('telephon',20);
            $table->unsignedBigInteger('payment_method_id')->comment('FK');
            $table->foreign('payment_method_id')->references('id')->on('payment_methods')->onDelete('cascade');
            $table->unsignedBigInteger('payment_form_id')->comment('FK');
